-- User Test Register
INSERT INTO users (name, phone_code, phone_number, phone_share, password, email, image_url, user_active, detail, address, country, forgot_password, created_at, updated_at)
...
(3, 10, 'Urban Loft Living', 'cottage', 180.00, 'Modern loft with stunning city skyline views.', -75.456789, 40.567890, 4.8, '567 Loft Avenue', 'Cityscape City', 'United States', '16:00:00', '11:00:00', NOW(), NULL),
...
(5, 4, 'Historic Inn Experience', 'hotel', 200.00, 'Step back in time at this beautifully restored inn.', -0.678901, 51.234567, 4.9, '123 Vintage Street', 'Historic Town', 'United Kingdom', '16:00:00', '12:00:00', NOW(), NULL),
